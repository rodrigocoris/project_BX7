...
export const catalogCategories = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1618843479313-40f8afb4b4d0?w=640&h=420&fit=crop&q=80',
    icon: 'disc' as const,
  },
  {
    id: 'suspension',
    name: 'Suspensión',
    description: 'Kits y componentes de suspensión',
    count: '362 productos',
    image: 'https://images.unsplash.com/photo-1486262715619-67b85e0b08f3?w=640&h=420&fit=crop&q=80',
    icon: 'layers' as const,
  },
  {
    id: 'iluminacion',
    name: 'Iluminación',
    description: 'Faros y barras LED',
    count: '891 productos',
    image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=640&h=420&fit=crop&q=80',
    icon: 'light' as const,
  },
  {
    id: 'espaciadores',
    name: 'Espaciadores',
    description: 'Hub centric y adaptadores',
    count: '224 productos',
    image: 'https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=640&h=420&fit=crop&q=80',
    icon: 'spacer' as const,
  },
  {
    id: 'accesorios',
    name: 'Accesorios',
    description: 'Accesorios off-road',
    count: '1,540 productos',
    image: 'https://images.unsplash.com/photo-1552519507-da3b142c6e3d?w=640&h=420&fit=crop&q=80',
    icon: 'box' as const,
  },
  {
    id: 'herramientas',
    name: 'Herramientas',
    description: 'Herramientas y mounting',
    count: '186 productos',
    image: 'https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d5?w=640&h=420&fit=crop&q=80',
